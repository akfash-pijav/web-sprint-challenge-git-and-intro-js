...
Fix this issue and console.log() to check your work. */
artists.splice(8, 1, {
  "id": 8,
...
function removeArtist(array, arrayIndex) {
  const nameToDelete = array[arrayIndex].name;
  let newArray =[];
  array.map(artist=>{
...
artistInfo(artists, 'Peter Paul Rubens');
